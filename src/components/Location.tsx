      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="rounded-xl overflow-hidden shadow-lg h-[400px] bg-muted">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.5!2d77.0384!3d28.4089!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d229e88fd54c5%3A0x86d0e45b6c39fc45!2sElement%20One%20Mall!5e0!3m2!1sen!2sin!4v1234567890" width="100%" height="100%" style={{
            border: 0
          }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="The Salad House Location" />
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://maps.app.goo.gl/zcTqdhNBCDMFdQec6" target="_blank" rel="noopener noreferrer" className="text-primary hover:text-primary/80 transition-colors text-sm font-medium inline-flex items-center gap-1">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1 text-primary">Hours</h4>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="font-semibold mb-1 text-primary">Contact</h4>
                    <p className="text-muted-foreground">
